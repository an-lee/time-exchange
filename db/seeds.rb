...
p1 = Product.create([title:products[0][:title],description:products[0][:description],category:products[0][:category],quantity:20,price:10,image:open(products[0][:image_path])])
